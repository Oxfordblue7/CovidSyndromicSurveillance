...
def evaluate(goldStd='./Assignment1GoldStandardSet.xlsx', annofile='./AssignmentSampleSubmission.xlsx'):
    gold_standard_dict = load_labels(goldStd)
    submission_dict = load_labels(annofile)
...
# evaluate('./Assignment1GoldStandardSet.xlsx', './s4.xlsx')